...
| 选具体机器 | [单品档案 · 尼康 F801](../../设备与工具/设备/单品档案/相机/NIKON-F801.md) / [美能达 α7700i](../../设备与工具/设备/单品档案/相机/MINOLTA-a7700i.md) | 具体型号规格、行情与逐项验机 |
...
| 读者画像 | 推荐路径 |
| --- | --- |
| 还没买机器 | 先读[胶片机身怎么选](胶片机身怎么选.md)定类型 → 再进[新手第一卷指南](新手第一卷指南.md)照做 |
| 已有机器想开张 | [新手第一卷指南](新手第一卷指南.md)从头读到尾 → 拍完回来读[冲洗](冲洗送冲与自冲.md)的送冲节 → 出问题查[故障诊断](常见故障诊断.md) |
...
换算成月预算更直观：每月两卷彩负 + 冲扫 ≈ **130–260 元/月**——这是普通玩家最真实的持有成本；每月四卷以上再考虑自冲摊薄；拍立得另算（单张 5–20 元，见[机身篇](胶片机身怎么选.md)）。

省钱杠杆按效果排序：①过期货与促销卷（打六到八折，风险见[过期胶片](胶片种类与选择.md)）；②黑白银卷自冲（变动成本压到每卷十元内）；③微距翻拍代替底扫店精扫（设备一次投入后近乎零边际成本）。若预算极度有限，[半格机与一次性机](胶片机身怎么选.md)是另外两条低门槛起步线。

## 与其他分组的关系

本组是摄影栏里的**平行工作流**，与既有分组有三条清晰的接口：

- **原理同源**：曝光三要素、构图、用光的底层知识与数码完全一致，本组只讲胶片特有的差异部分（宽容度方向、倒易律、估光），原理回链[器材](../器材/相机机身.md)与[拍摄技术](../拍摄技术/构图.md)，不重复展开；
- **终点汇合**：数字化之后的精修就是[后期处理](../后期处理/Lightroom工作流.md)的常规技能，两条链路在此汇成一条；
- **机器互通**：拍胶片的机器是[设备与工具 · 单品档案](../../设备与工具/设备/README.md)的一部分，规格与验机细节都在那边，本组只负责"怎么用它拍"。
